...
jQuery(document).ready(function () {
  jQuery('.youtube-video-image-col').click(function () {
    disableBodyScroll(document.querySelector('.youtube-video-dialog'))

    var $videoElem = jQuery('.youtube-video-dialog', jQuery(this).parent().parent().parent())
    var $videoWrapperElem = jQuery('.video-responsive', jQuery(this).parent().parent().parent())
  ...
  jQuery('.youtube-video-btn a').click(function () {
    disableBodyScroll(document.querySelector('.youtube-video-dialog'))

    var $videoElem = jQuery('.youtube-video-dialog', jQuery(this).parent().parent().parent().parent().parent().parent())
    var $videoWrapperElem = jQuery('.video-responsive', jQuery(this).parent().parent().parent().parent().parent().parent())
    var videoUrl = jQuery($videoWrapperElem).attr('data-video-url')
  ...
  //   if( jQuery('body').hasClass('youtube-video-dialog-open') ){
  //     if( !jQuery(event.target).closest('.youtube-video-dialog-inner').length ){
  //       enableBodyScroll(document.querySelector('.youtube-video-dialog'))

  //       jQuery('.youtube-video-dialog').fadeOut()
