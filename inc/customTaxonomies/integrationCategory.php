...
function registerIntegrationCategory()
{
    $labels = [
    ...
    register_taxonomy('integration-category', ['integration'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerIntegrationCategory');
