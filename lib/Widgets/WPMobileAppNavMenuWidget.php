...
class WPMobileAppNavMenuWidget extends WP_Widget
{
    ...
    {
        $widget_ops = array(
            'description'                 => __('Add a mobile app navigation to your sidebar.'),
            'customize_selective_refresh' => true,
        );
        parent::__construct('mobile_app_nav_menu', __('Mobile App Navigation'), $widget_ops);
    }
    ...
    public function widget($args, $instance)
    {
        ...
        echo '<div class="custom-html-widget">';
        ...
        foreach ($array_menu as $menu) {
            ...
            echo "<div class=\"{$classes}\"><a href=\"{$menu->url}\"><img src=\"{$image}\"></a></div>";
        }
        echo '</div>';
